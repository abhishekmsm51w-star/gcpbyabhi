...
echo "${NEON_GREEN}${BOLD}            🚀 DR ABHISHEK CLOUD AUTOMATION LAB 🚀${RESET}"
echo "${ROYAL_BLUE}${BOLD}============================================================${RESET}"
echo
echo "${WHITE}Welcome to this automated Google Cloud setup script.${RESET}"
echo
echo "${ORANGE}${BOLD}👉 Subscribe to the channel:${RESET}"
echo "${NEON_GREEN}${BOLD}https://www.youtube.com/@drabhishek.5460/videos${RESET}"
echo
sleep 2
